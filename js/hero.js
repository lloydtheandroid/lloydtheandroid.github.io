    ...
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) jQuery.noop();
        ...
        $("#hero .social, #hero .social > a").off("mouseenter mouseleave"),
            ...
            $("social").on("mouseleave", function() {
                $(".social > a").fadeTo(100, 1)
            }),
            $(".social > a.twitter").on("mouseenter", function() {
            ...
            $(".social > a.facebook").on("mouseenter", function() {
            ...
            $(".social > a.dribbble").on("mouseenter", function() {
            ...
            $(".social > a.instagram").on("mouseenter", function() {
            ...
            $(".social > a.github").on("mouseenter", function() {
